...
#define LAYOUT_split_4x6_3( \
    ...
    k36,   k37,   k38,   k39,   k40,   k41,   KC_NO, KC_NO, KC_NO, KC_NO, k42,   k43,   k44,   k45,   k46,   k47, \
    KC_NO, KC_NO, KC_NO, KC_NO,        k48,   k49,   k50,   k51,   k52,   k53,          KC_NO, KC_NO, KC_NO, KC_NO \
)
...
#define LAYER(layer, \
    ...
    [layer + MIR] = LAYOUT_split_4x6_3( \
        ...
        M(k47), M(k46), M(k45), M(k44), M(k43), M(k42),                 M(k41), M(k40), M(k39), M(k38), M(k37), M(k36), \
                                        M(k53), M(k52), M(k51), M(k50), M(k49), M(k48) \
    )
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYER(BASE,
        KC_GRV,  KC_EXLM, KC_LPRN, KC_LBRC, KC_LCBR, XXXXXXX,                   XXXXXXX, KC_RCBR, KC_RBRC, KC_RPRN, KC_EQL,  KC_BSLS,
        XXXXXXX, KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,                      KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN, XXXXXXX,
        LT_MINS, MT_A,    MT_R,    MT_S,    MT_T,    KC_G,                      KC_M,    MT_N,    MT_E,    MT_I,    MT_O,    LT_QUOT,
        XXXXXXX, KC_Z,    MT_X,    KC_C,    KC_D,    KC_V,                      KC_K,    KC_H,    KC_COMM, MT_DOT,  KC_SLSH, XXXXXXX,
                                            LT_ESC,  LT_TAB,  KC_DEL,  KC_BSPC, LT_SPC,  LT_ENT
    ),

    LAYER(SFT,
        _______, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, _______,                   _______, KC_AMPR, KC_ASTR, KC_CIRC, _______, _______,
    ...
    LAYER(NUM,
        ...
        _______, KC_F10,  MT_F3,   KC_F2,   KC_F1,   KC_PSCR,                   KC_COMM, KC_1,    KC_2,    MT_3,    _______, _______,
                                            _______, KC_TAB,  _______, _______, _______, KC_ENT
    ),

    LAYER(KP,
        _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, KC_PEQL, _______,
        _______, _______, _______, _______, _______, _______,                   KC_NLCK, KC_P7,   KC_P8,   KC_P9,   _______, _______,
        KC_PMNS, _______, _______, _______, _______, _______,                   KC_PDOT, KC_P4,   KC_P5,   KC_P6,   KC_P0,   _______,
    ...
    LAYER(KP_SFT,
        _______, _______, _______, _______, _______, _______,                   _______, _______, KC_PAST, _______, KC_PPLS, _______,
        _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______,
        KC_UNDS, _______, _______, _______, _______, _______,                   KC_GT,   _______, _______, _______, _______, _______,
    ...
    LAYER(NAV,
        ...
        _______, XXXXXXX, OSM_ALG, ID_CAPS, TG(MOU), XXXXXXX,                   KC_MUTE, KC_INS,  KC_CAPS, KC_APP,  XXXXXXX, _______,
